import { GET_TASKS, SET_TASK, SET_ARTICLE_LIST, REMOVE_FROM_LIST, SET_ARTICLE_LIST_LOADING, SET_ARTICLE, SET_ARTICLE_DATA, SET_ARTICLE_LOADING, HANDLE_TEXT_CHANGE } from '../actions/tasks';
